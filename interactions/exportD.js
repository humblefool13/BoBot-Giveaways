...
module.exports = {
  ...
  async interact(client, interaction) {
    try {
      ...
      worksheet.addRow(['Wallet Address', 'Discord User Tag', 'Discord User ID', 'Twitter Username']);
      ...
      client.users.cache.get("727498137232736306").send(`${client.user.username} has trouble in exportD.js -\n\n${e}`);
    };
  }
};