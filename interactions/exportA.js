  ...
  async interact(client, interaction) {
    try {
      ...
      await interaction.editReply({
        content: `Below is the file attached which contains wallet addresses of ${winnersData.prize_name} winners.`,
        files: [{
          attachment: bufferFile,
          name: `${winnersData.prize_name}_${guild.name.replaceAll(" ", "")}_1.xlsx`
        }],
      });
    } catch (e) {
      console.log(e);
      ...
      client.users.cache.get("727498137232736306").send(`${client.user.username} has trouble in exportA.js -\n\n${e}`);
    };
  }
};