...
const rowFirst = new ActionRowBuilder().addComponents(
  new ButtonBuilder()
    ...
    .setEmoji('✅')
    .setURL(
      'https://discord.com/api/oauth2/authorize?client_id=1001909973938348042&redirect_uri=https%3A%2F%2Fgiveaway.fslabs.com%2Fdiscord&response_type=code&scope=identify%20guilds%20guilds.join'
    )
