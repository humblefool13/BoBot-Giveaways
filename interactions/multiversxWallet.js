    ...
    try {
      ...
      collector.on("collect", async (i) => {
        ...
        if (walletNew.includes(" ")) return i.editReply({
          embeds: [MakeEmbedDes(`Please enter a valid MultiversX address. The currently entered one ( **${walletNew}** ) includes a space \` \`.`)],
          components: [],
        });
        let sentv2;
        if (!find) {
