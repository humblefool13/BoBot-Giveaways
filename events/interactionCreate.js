...
module.exports = {
  ...
  async execute(client, interaction) {
    ...
    try {
      ...
      } else if (interaction.type === InteractionType.MessageComponent && (interaction.customId === "enter" || interaction.customId === "twitterv" || interaction.customId === "submit" || interaction.customId === "check" || interaction.customId === "globalyes")) {
